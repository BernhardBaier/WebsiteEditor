 ...
 * Time: 11:27
 */
if(basename($_SERVER["SCRIPT_FILENAME"]) != 'login.php' && basename($_SERVER["SCRIPT_FILENAME"]) != 'register.php' && basename($_SERVER["SCRIPT_FILENAME"]) != 'calendar.php' && substr(basename($_SERVER["SCRIPT_FILENAME"]),0,9) != 'index.php' && substr(basename($_SERVER["SCRIPT_FILENAME"]),0,10) != 'search.php' && substr(basename($_SERVER["SCRIPT_FILENAME"]),0,15) != 'getSubpages.php'){
    include('auth.php');
}
